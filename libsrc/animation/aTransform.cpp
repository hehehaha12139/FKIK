...
ATransform ATransform::Inverse() const
{
	...
	mat3 rotation_transpose = m_rotation.Transpose();
	vec3 translate_inverse = -(rotation_transpose * m_translation);
	result.m_rotation = rotation_transpose;
	result.m_translation = translate_inverse;
