...
{
public:
	enum InterpolationType { LINEAR, CUBIC_BERNSTEIN, CUBIC_CASTELJAU, CUBIC_MATRIX, CUBIC_HERMITE, CUBIC_BSPLINE, STAIR_CASE};
...
class AStaircaseInterpolatorVec3 : public ACubicInterpolatorVec3 
{
public:
	AStaircaseInterpolatorVec3() : ACubicInterpolatorVec3(ASplineVec3::STAIR_CASE) {}
	virtual void computeControlPoints(
		const std::vector<ASplineVec3::Key>& keys,
		std::vector<vec3>& ctrlPoints,
		vec3& startPt, vec3& endPt);
